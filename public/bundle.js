...
(function($PS) {
          ...
          return function (nextAccel) {
              return function (dt) {
                  return Data_Semiring.add(Data_Semiring.semiringRecord()(Data_Semiring.semiringRecordCons(new Data_Symbol.IsSymbol(function () {
                      ...
                      return "y";
                  }))()(Data_Semiring.semiringRecordNil)(Data_Semiring.semiringNumber))(Data_Semiring.semiringNumber)))(vel)(vmul(Data_Semiring.add(Data_Semiring.semiringRecord()(Data_Semiring.semiringRecordCons(new Data_Symbol.IsSymbol(function () {
                      return "x";
                  }))()(Data_Semiring.semiringRecordCons(new Data_Symbol.IsSymbol(function () {
                      return "y";
          ...
          return function (acc) {
              return function (dt) {
                  return Data_Semiring.add(Data_Semiring.semiringRecord()(Data_Semiring.semiringRecordCons(new Data_Symbol.IsSymbol(function () {
                      ...
                      return "y";
                  }))()(Data_Semiring.semiringRecordNil)(Data_Semiring.semiringNumber))(Data_Semiring.semiringNumber)))(pos)(vmul(vel)(dt)))(vmul(acc)(0.5 * $$Math.pow(dt)(2.0)));
              };
          };
      };
  };
  ...
  var updateState = function (state) {
      return function (deltaTime) {
          ...
          var unitVect = vmap((function () {
              var $71 = Data_Function.flip(Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingNumber))(radius);
              var $72 = Data_Ring.negate(Data_Ring.ringNumber);
              return function ($73) {
                  return $71($72($73));
              };
          })())(state.pos);
          ...
          var newUnitVect = vmap((function () {
              var $74 = Data_Function.flip(Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingNumber))(newRadius);
              var $75 = Data_Ring.negate(Data_Ring.ringNumber);
              return function ($76) {
                  return $74($75($76));
              };
          })())(newPos);
          ...
          return {
              ...
              vel: newVel,
              masses: state.masses,
              positions: [ vmul(newPos)(state.masses.m2 / state.masses.total), vmul(newPos)(-(state.masses.m1 / state.masses.total)) ]
          };
      };
  };
