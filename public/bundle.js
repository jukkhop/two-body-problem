...
(function($PS) {
  ...
  var getCanvas = function (dictPartial) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at Utils (line 18, column 3 - line 20, column 31): " + [ v.constructor.name ]);
      };
  };
...
(function($PS) {
  ...
  var initialState = function (v) {
      return {
          ...
          vel: {
              x: 0.0,
              y: initialVelocity(1.0)(v.eccentricity)
          },
          masses: {
              m1: 1.0,
              m2: v.massRatio,
              ratio: v.massRatio,
              total: 1.0 + v.massRatio
          },
          positions: [ {
              x: 0.0,
              y: 0.0
      ...
      return function (v1) {
          return function (radius) {
              return function (unitv) {
                  var scalar = (v.gravity * v1.m1 * v1.m2) / $$Math.pow(radius)(2.0);
                  return Vector.vmul(unitv)(scalar);
              };
          };
      };
  };
  var updateState = function (consts) {
      return function (state) {
          var radius = hypotenuse(state.pos);
          var unitVect = Vector.vmap((function () {
              var $23 = Data_Function.flip(Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingNumber))(radius);
              var $24 = Data_Ring.negate(Data_Ring.ringNumber);
              return function ($25) {
                  return $23($24($25));
              };
          })())(state.pos);
          var currAccel = accel(consts)(state.masses)(radius)(unitVect);
          ...
          var newUnitVect = Vector.vmap((function () {
              var $26 = Data_Function.flip(Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingNumber))(newRadius);
              var $27 = Data_Ring.negate(Data_Ring.ringNumber);
              return function ($28) {
                  return $26($27($28));
              };
          })())(newPos);
          var newAccel = accel(consts)(state.masses)(newRadius)(newUnitVect);
...
(function($PS) {
      ...
      return function (ctx) {
          return function (state) {
              ...
              return function __do() {
                  ...
                  Effect.foreachE(Data_Functor.mapFlipped(Data_Functor.functorArray)(state.positions)(Utils.translatePos(dims)(config.scale)))(function (v) {
                      return function __do() {
  ...
  var simulate = function (wind) {
      return function (dims) {
          return function (ctx) {
              return function (state) {
                  var newState = World.updateState(consts)(state);
                  return function __do() {
  ...
  var main = function __do() {
      ...
      var state = World.initialState(consts);
      var dims = {
          width: Data_Int.toNumber(v3),
          height: Data_Int.toNumber(v4)
      };
      Utils.scaleCanvas(v2)(v)(v1)(config.pixelRatio)();
